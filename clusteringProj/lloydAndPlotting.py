...
#num_lines = sum(1 for line in open('/cleanExpMatrix.txt'))

#data = [[float(x) for x in line.split()] for line in input_lines[1:]]
#data = np.array([[float(x) for x in line.split()] for line in input_lines[1:]],dtype=float)
#print(data)
