...
# Reference/Citation: https://www.w3schools.com/python/python_file_open.asp
# Reference/Citation: https://mail.python.org/pipermail/python-list/2001-February/105300.html
...
def generateDNA(filename):
  ...
  Sequences = []
  f = open("DnaSequences.txt", "r")
  currLine = f.readline()
  while currLine:
    Sequences.append(currLine)
    currLine = f.readline()
  f.close()
  ...
  currLine = g.readline()
  while currLine:
    DNA.append(Sequences[int(currLine)])
    currLine = g.readline()
  g.close()
